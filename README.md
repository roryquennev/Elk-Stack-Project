...
* [pentest.yml](./Ansible/pentest.yml) - Used to install the DVWA
* [ELK-Playbook.yml](./Ansible/ELK-Playbook.yml) - Used to install ELK
* [Filebeat-playbook.yml](./Ansible/Filebeat-Playbook.yml) - Used to install Filebeat
* [Metricbeat-playbook.yml](./Ansible/Metricbeat-Playbook.yml) - Used to install Metricbeat
